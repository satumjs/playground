...
export default props => {
  ...
  const userConfig = {
    ...{'name':'satumjs-demo','theme':'PRO','locale':true,'showBreadcrumb':true,'siderWidth':208,'navTheme':'light','primaryColor':'#1890ff','layout':'mix','contentWidth':'Fluid','fixedHeader':false,'fixSiderbar':true,'colorWeak':false,'title':'Satumjs demo','pwa':false,'logo':'https://gw.alipayobjects.com/mdn/rms_edced6/afts/img/A*KfcRTYnC4eoAAAAAAAAAAAAAARQnAQ','iconfontUrl':''},
    ...runtimeConfig || {}
  };
